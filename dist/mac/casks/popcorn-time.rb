cask "popcorn-time" do
  ...
  if Hardware::CPU.intel?
    ...
    url "https://github.com/Jalvcl/popcorn-desktop-ru/releases/download/v#{version}/Popcorn-Time-#{version}-osx64.zip"
    arch = "x64"
  else
    sha256 "51f11fb0483983dd6c4baddf12938d8a85b8320e3499dbe12cbcf5e4146e7f74"
    url "https://github.com/Jalvcl/popcorn-desktop-ru/releases/download/v#{version}/Popcorn-Time-#{version}-osxarm64.zip"
    arch = "arm64"
  end

  name token.gsub(/\b\w/, &:capitalize)
  desc "BitTorrent client that includes an integrated media player"
  homepage "https://github.com/Jalvcl/popcorn-desktop-ru/releases/download/v0.5.1/Popcorn-Time-0.5.1-osx64.zip"

  repo = "Jalvcl/popcorn-desktop-ru"
